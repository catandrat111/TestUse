...
- (void)viewDidLoad {
    [super viewDidLoad];
    dataSource = @[@"webview1",@"webview2",@"webview3",@"webview4"];
    dict = @{@"webview1":@"WebView1ViewController",@"webview2":@"WebView2ViewController",@"webview3":@"WebView3ViewController",@"webview4":@"WebView4ViewController"};
