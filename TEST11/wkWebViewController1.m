...
#import "wkWebViewController1.h"
#import <WebKit/WebKit.h>
@interface wkWebViewController1 ()<WKScriptMessageHandler, WKNavigationDelegate, WKUIDelegate>
@property (nonatomic, strong) WKWebView *webView;
@property (nonatomic, strong) UIProgressView *progressView;

@end

@implementation wkWebViewController1
...
- (void)viewDidLoad {
    ...
    NSURL *path = [[NSBundle mainBundle] URLForResource:@"test4ß" withExtension:@"html"];
