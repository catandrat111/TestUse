...
- (void)drawBorder{
    [self drawBorderWidth:1.0f color:[UIColor grayColor] radius:2];
}

- (void)drawBorderWidth:(CGFloat)width color:(UIColor *)color{
    [self drawBorderWidth:width color:color radius:2];
}

- (void)drawBorderWidth:(CGFloat )width color:(UIColor *)color radius:(CGFloat)radius{
