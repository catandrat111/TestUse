...
@interface DSLFirstViewController ()<UINavigationControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
- (void)viewDidLoad
{
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"DSLThingCell" bundle:nil] forCellWithReuseIdentifier:@"DSLThingCell"];
  _things = [DSLThing exampleThings];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Set the thing on the view controller we're about to show
    if (selectedIndexPath != nil) {
        DSLSecondViewController *secondViewController = [DSLSecondViewController new];
        secondViewController.thing = self.things[selectedIndexPath.row];
