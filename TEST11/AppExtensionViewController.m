//
//  AppExtensionViewController.m
//  TEST11
//
//  Created by dongjl on 16/11/2.
//  Copyright © 2016年 djl. All rights reserved.
//

#import "AppExtensionViewController.h"
#import <Dylib/Dylib.h>
#import <NotificationCenter/NCWidgetController.h>
@interface AppExtensionViewController ()
{
    IBOutlet    UITextField *_textField;
}
@end

@implementation AppExtensionViewController
...
{
    [[NCWidgetController widgetController] setHasContent:YES forWidgetWithBundleIdentifier:@"com.test8.ToDoListTodayExtension"];
}

//隐藏插件
- (void)hiddeTodayExtension
{
    [[NCWidgetController widgetController] setHasContent:NO forWidgetWithBundleIdentifier:@"com.test8.ToDoListTodayExtension"];
}

//通过NSUserDefaults保存text
- (void)saveTextByNSUserDefaults
{
    NSUserDefaults *shared = [[NSUserDefaults alloc] initWithSuiteName:@"group.com.test8.test"];
