...
{
    NSError *err = nil;
    NSURL *containerURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:@"group.com.test8.test"];
...
- (IBAction)selector:(id)sender
{
    ...
    NSString* str = [self readDataFromNSUserDefaults];
